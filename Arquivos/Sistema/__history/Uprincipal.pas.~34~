...
uses ufrmCadastroBasico, ufrmCadastroUsuarios, ufrmCadastroCaixa,
  ...
  ufrmConsReceber, ModConexao, ufrmLogin, ufrmSaldoCaixa, ufrmEmitirRecibo,
  ufrmConsRecibos;
...
procedure TfrmPrincipal.btn_reciboClick(Sender: TObject);
begin
frmEmitirRecibo := TfrmEmitirRecibo.Create(nil);
  try
    frmEmitirRecibo.ShowModal;
  finally
   FreeAndNil (frmEmitirRecibo);
  end;
end;
